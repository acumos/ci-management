...
def check_jjb_version(tox_file, releng_jobs_file):
    ...
    print("JJB version in jjb/ci-management/ci-management.yaml: {}".format(jjb_version))
    print("JJB version in tox.ini: {}".format(jjb_version_tox))

    if jjb_version != jjb_version_tox:
        print("ERROR: JJB version in jjb/ci-management/ci-management.yaml and tox.ini MUST match.")
        sys.exit(1)
