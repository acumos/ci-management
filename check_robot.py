...
if __name__ == "__main__":
    ...
    if len(robots) > 1:
        log.info("ERROR: More than one robot system type definition detected.")
        log.info("Please ensure that ALL templates use the same robot nodes.")
        log.info("Infra does not support more than 1 robot node type in use.")
        sys.exit(1)
