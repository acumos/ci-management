...
# This Acumos version modifies original in global-jjb/shell:
#  - uses log level INFO to show maven download progress messages
#  - publishes maven property with Jenkins build number
